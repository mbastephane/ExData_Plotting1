...
plot(data_period$Time, data_period$Voltage, type="n", main="",  xlab = "datetime", ylab = "Voltage") 
lines(data_period$Time, data_period$Voltage, type="l")
...
plot(data_period$Time, data_period$Global_reactive_power, type="n", main="",  xlab = "datetime", ylab = "Global Active Power (kilowatts)") 
lines(data_period$Time, data_period$Global_reactive_power, type="l")
